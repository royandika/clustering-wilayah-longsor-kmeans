  ...
  <body class="text-center">
	<main class="form-signin">
	  <?=form_open('login/proses');?>
		<img class="mb-4" src="<?=base_url('asset/image/pln_logo.png');?>" alt="" width="72" height="57">
		...
		<p class="mt-5 mb-3 text-muted">&copy; 2022 by <a href="https://royandika.my.id">Roy Andika</a></p>
	  <?=form_close();?>
	</main>
	<!-- Bootstrap core JS-->
